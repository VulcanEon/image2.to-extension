...
Build better GPT Image 2 prompts for image2.to.
...
This extension is designed for quick prompt planning inside the browser side panel. It does not edit web pages, track browsing activity, or require account sign-in.
...
image2.to GPT Image 2 提示词助手

### 短描述

为 image2.to 快速生成更清晰的 GPT Image 2 图像提示词。

### 详细描述

image2.to GPT Image 2 提示词助手用于在浏览器侧边栏里快速搭建图像生成提示词。选择一个提示词起点，再补充主体、风格、比例、文字、光线或参考说明，即可得到一条更适合 GPT Image 2 的 prompt。

这个扩展不读取网页内容、不追踪浏览行为，也不需要登录。你可以一键复制提示词，或继续前往 image2.to 的 GPT Image 2 工作流完成生成。
